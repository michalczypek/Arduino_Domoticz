...
#define NUMBER_OF_RELAYS 66 // Total number of attached relays
...
//-----------------------------------------------------------------------
  if (debouncer51.update()) {
    ...
    if(value51 == LOW){
         ...
         digitalWrite(RELAY_51, loadState(51)?RELAY_ON:RELAY_OFF);
...
//-----------------------------------------------------------------------
  if (debouncer52.update()) {
    ...
    if(value52 == LOW){
         ...
         digitalWrite(RELAY_52, loadState(52)?RELAY_ON:RELAY_OFF);
...
if (debouncer53.update()) {
    ...
    if(value53 == LOW){
         ...
         digitalWrite(RELAY_53, loadState(53)?RELAY_ON:RELAY_OFF);
...
if (debouncer54.update()) {
    ...
    if(value54 == LOW){
         ...
         digitalWrite(RELAY_54, loadState(54)?RELAY_ON:RELAY_OFF);
...
if (debouncer55.update()){
    ...
    if(value55 == LOW){
         ...
         digitalWrite(RELAY_55, loadState(55)?RELAY_ON:RELAY_OFF);
...
if (debouncer56.update()) {
    ...
    if(value56 == LOW){
         ...
         digitalWrite(RELAY_56, loadState(56)?RELAY_ON:RELAY_OFF);
...
if (debouncer57.update()) {
    ...
    if(value57 == LOW){
         ...
         digitalWrite(RELAY_57, loadState(57)?RELAY_ON:RELAY_OFF);
...
if (debouncer58.update()) {
    ...
    if(value58 == LOW){
         ...
         digitalWrite(RELAY_58, loadState(58)?RELAY_ON:RELAY_OFF);
...
if (debouncer59.update()) {
    ...
    if(value59 == LOW){
         ...
         digitalWrite(RELAY_59, loadState(59)?RELAY_ON:RELAY_OFF);
...
if (debouncer60.update()) {
    ...
    if(value60 == LOW){
         ...
         digitalWrite(RELAY_60, loadState(60)?RELAY_ON:RELAY_OFF);
         send(msg60.set(loadState(60)));
         }
  }
//-----------------------------------------------------------------------
  if (debouncer61.update()) {
    int value61 = debouncer61.read();
    if(value61 == LOW){
         saveState(61, !loadState(61));
         digitalWrite(RELAY_61, loadState(61)?RELAY_ON:RELAY_OFF);
         send(msg61.set(loadState(61)));
         }
  }
//-----------------------------------------------------------------------
  if (debouncer62.update()) {
    ...
    if(value62 == LOW){
         ...
         digitalWrite(RELAY_62, loadState(62)?RELAY_ON:RELAY_OFF);
...
if (debouncer63.update()) {
    ...
    if(value63 == LOW){
         ...
         digitalWrite(RELAY_63, loadState(63)?RELAY_ON:RELAY_OFF);
...
if (debouncer64.update()) {
    ...
    if(value64 == LOW){
         ...
         digitalWrite(RELAY_64, loadState(64)?RELAY_ON:RELAY_OFF);
...
if (debouncer65.update()){
    ...
    if(value65 == LOW){
         ...
         digitalWrite(RELAY_65, loadState(65)?RELAY_ON:RELAY_OFF);
...
if (debouncer66.update()) {
    ...
    if(value66 == LOW){
         ...
         digitalWrite(RELAY_66, loadState(66)?RELAY_ON:RELAY_OFF);
